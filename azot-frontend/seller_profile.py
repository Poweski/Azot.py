...
class ProfileFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkButton(self, text='Back', command=master.create_seller_main_frame).grid(row=6, column=2, pady=10)
    ...
    def save_profile(self):
        ...
        url = f'http://localhost:8080/api/seller/{self.master.active_user_id}'
